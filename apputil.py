...
def parentheses_balancer(user_input):
    #return true if input parentheses are balanced
...
print("The following parentheses are balanced (T/F):", parentheses_balancer(user_input))
